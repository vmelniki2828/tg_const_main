      ...
      <div className="quiz-stats-modal">
        ...
        {error ? (
          <div className="error-message">
            ...
            <p>Проверьте: (1) бэкенд запущен, (2) порт 3001 открыт, или откройте приложение через порт 80 (nginx проксирует /api на бэкенд).</p>
            <button onClick={() => { setError(null); fetchStats(); }} className="retry-btn">
              🔄 Повторить загрузку
            </button>
          </div>
        ) : quizBlocks.length === 0 ? (
