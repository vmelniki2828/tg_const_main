...
# Останавливаем внешнюю MongoDB (если запущена)
echo "🛑 Останавливаем внешнюю MongoDB..."
pkill -f "mongod.*27017" || echo "Внешняя MongoDB не запущена"

# Запускаем только MongoDB
echo "🚀 Запускаем локальную MongoDB на порту 27018..."
...
echo "🌐 Проверяем API..."
sleep 10
curl -s http://157.230.20.252:3001/api/health || echo "⚠️ API еще не готов"

echo "✅ Миграция завершена!"
echo "🌐 Фронтенд: http://157.230.20.252:3000"
echo "🔧 API: http://157.230.20.252:3001"
echo "🗄️ MongoDB: localhost:27018 (внешний порт)"
echo ""
